...
export default ({ history }) => {
    ...
    return (<div className="bg-gray-200">
        ...
        loginHandler(e);
                            ...
                            <input type="email" className="my-1 p-1 w-full outline-none border" name="userEmail" placeholder="E.g: hajira@gmail.com" value={user && user.email ? user.email : ""} onChange={(e) => {
        setError("");
        let dub = { ...user };
        ...
        setUser(dub);
                            ...
                            <input type="password" className="mt-1 mb-3 p-1 w-full outline-none border" name="userPassword" value={user && user.password ? user.password : ""} placeholder="Your Password" id="userPassword" onChange={(e) => {
        setError("");
        let dub = { ...user };
